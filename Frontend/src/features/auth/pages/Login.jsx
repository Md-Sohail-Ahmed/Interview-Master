...
const Login = () => {
    ...
    if (loading) {
        return <LoadingScreen title="Signing you in" message="Checking your account and preparing your dashboard." />
    }
        ...
        <div className="min-h-screen">
            ...
            <main className="relative flex min-h-[calc(100vh-81px)] items-center justify-center overflow-hidden px-4 py-10 sm:px-6">
                ...
                <div className="relative grid w-full max-w-6xl overflow-hidden rounded-[36px] border border-white/80 bg-white/85 shadow-[0_32px_90px_-42px_rgba(59,130,246,0.55)] backdrop-blur lg:grid-cols-[1.05fr_0.95fr]">
                    <section className="hidden bg-linear-to-br from-sky-500 via-sky-400 to-cyan-300 p-10 text-white lg:flex lg:flex-col lg:justify-between">
                        <div>
                            <h1 className="mt-6 text-5xl font-bold leading-tight">
                                Build a tailored interview report before you apply.
                            </h1>
                            <p className="mt-5 max-w-xl text-lg leading-8 text-sky-50/90">
                                Sign in to upload your resume, align with the role, and review focused practice plans in one clean workspace.
                            </p>
                        </div>
                    ...
                    <section className="p-6 sm:p-10">
                        <div className="mx-auto max-w-md">
                            ...
                            <h2 className="mt-6 text-4xl font-bold tracking-tight text-slate-800">
                                Login to continue your preparation.
                            </h2>
                            <p className="mt-4 text-base leading-7 text-slate-500">
                                Use your account to access saved reports, preparation roadmaps, and tailored question banks.
                            </p>
                            ...
                            <form onSubmit={handleSubmit} className="mt-10 space-y-5">
                                ...
                                <button className='inline-flex w-full items-center justify-center rounded-2xl bg-linear-to-r from-sky-500 to-cyan-400 px-5 py-3.5 text-base font-semibold text-white shadow-[0_18px_35px_-18px_rgba(14,116,255,0.8)] transition hover:-translate-y-0.5'>
                                    Login
                                </button>
                            </form>
                            ...
                            <p className="mt-6 text-sm text-slate-500">
                                ...
                                <Link className="font-semibold text-sky-700 hover:text-sky-800" to={"/register"}>Register</Link>
                            </p>
                        </div>
                    </section>
                </div>
